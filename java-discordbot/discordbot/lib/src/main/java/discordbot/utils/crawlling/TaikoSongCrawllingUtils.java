package discordbot.utils.crawlling;
...
import discordbot.utils.trim.TaikoSongNameSplitUtils;

public class TaikoSongCrawllingUtils {

    private Dbcp db = new Dbcp();
    private TaikoSongNameSplitUtils trimUtil = new TaikoSongNameSplitUtils();
